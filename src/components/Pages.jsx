    ...
    <div>
      ...
      <div className="bottom pt-4">
        <div className=" staf-dets grid grid-cols-12">
          <div className="user col-span-6">User</div>
        ...
        <div className="staff-dets-info">
          ...
          <StaffDet image="/images/Avatar2.png" name="Olivia Rhye" email="oliva.rhye@gmail.com" status="Active" date="24 Jan, 2023" type="GP" />
          <StaffDet image="/images/Avatar3.png" name="Olivia Rhye" email="oliva.rhye@gmail.com" status="Active" date="24 Jan, 2023" type="GP" />
          <StaffDet image="/images/Avatar4.png" name="Olivia Rhye" email="oliva.rhye@gmail.com" status="Active" date="24 Jan, 2023" type="GP" />
          <StaffDet image="/images/Avatar5.png" name="Olivia Rhye" email="oliva.rhye@gmail.com" status="Active" date="24 Jan, 2023" type="GP" />
          <StaffDet image="/images/Avatar6.png" name="Olivia Rhye" email="oliva.rhye@gmail.com" status="Active" date="24 Jan, 2023" type="GP" />
          <StaffDet image="/images/Avatar7.png" name="Olivia Rhye" email="oliva.rhye@gmail.com" status="Active" date="24 Jan, 2023" type="GP" />
          <StaffDet image="/images/Avatar8.png" name="Olivia Rhye" email="oliva.rhye@gmail.com" status="Active" date="24 Jan, 2023" type="GP" />
          <StaffDet image="/images/Avatar9.png" name="Olivia Rhye" email="oliva.rhye@gmail.com" status="Active" date="24 Jan, 2023" type="GP" />
          <StaffDet image="/images/Avatar10.png" name="Olivia Rhye" email="oliva.rhye@gmail.com" status="Active" date="24 Jan, 2023" type="GP" />
        </div>
      </div>
